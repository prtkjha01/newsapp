...
const News = (props) => {
  ...
  const updatenews = async () => {
    ...
    if (props?.searchQuery?.length === 0) {
      ...
      url = `https://newsapi.org/v2/everything?q=${props.searchQuery}&sortBy=popularity&apiKey=${apiKey}&page=${page}&pageSize=${props.pageSize}`;
    }
    setLoding(true);
              ...
              return (
                <div className="col-md-4 col-sm-6" key={index}>
                  <NewsItem
                    ...
                    date={element.publishedAt.slice(0, 10) + "," + element.publishedAt.slice(12, 16)}
